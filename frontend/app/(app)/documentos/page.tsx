...
const TEMPLATES = [
  {
    ...
    campos: [
      ...
      { key: "numero_oficio",    label: "Número de oficio SAT",  type: "text", placeholder: "500-05-2025-XXXXX" },
      { key: "fecha_oficio",     label: "Fecha del oficio",      type: "text", placeholder: "15 de abril de 2025" },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "ejercicio",              label: "Ejercicio fiscal",         type: "text", placeholder: "2025" },
  ...
  },
  {
    ...
    campos: [
      ...
      { key: "vigencia_inicio",      label: "Vigencia inicio",            type: "text", placeholder: "1 de enero de 2025" },
      { key: "vigencia_fin",         label: "Vigencia fin",               type: "text", placeholder: "31 de diciembre de 2025" },
      { key: "lugar",                label: "Lugar",                      type: "text", placeholder: "Ciudad de México" },
    ],
  },
  {
    ...
    campos: [
      ...
      { key: "numero_requerimiento",   label: "Número de requerimiento", type: "text", placeholder: "300-SAT-2025-XXXXX" },
      { key: "fecha_requerimiento",    label: "Fecha del requerimiento", type: "text", placeholder: "10 de abril de 2025" },
